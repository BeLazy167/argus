...
// The PipelineStateFunc type is an adapter to allow the use of ordinary
// function as PipelineState mutator.
type PipelineStateFunc func(context.Context, *ent.PipelineStateMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PipelineStateFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.PipelineStateMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PipelineStateMutation", m)
}
...
// The ReviewCommentFunc type is an adapter to allow the use of ordinary
// function as ReviewComment mutator.
type ReviewCommentFunc func(context.Context, *ent.ReviewCommentMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ReviewCommentFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ReviewCommentMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ReviewCommentMutation", m)
}
