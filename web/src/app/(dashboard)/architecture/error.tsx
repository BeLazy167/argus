    ...
    <div className="flex h-full flex-col items-center justify-center gap-4 p-8">
      <div className="border border-red-500/20 bg-red-500/5 p-6 text-center">
        <h2 className="mb-2 font-mono text-sm font-medium text-red-400">
          Failed to load architecture view
        </h2>
        ...
        <button
          onClick={reset}
          className="border border-zinc-700 bg-zinc-800 px-4 py-1.5 font-mono text-xs text-zinc-300 transition-colors hover:bg-zinc-700"
        >
          Try again
        </button>
      </div>
